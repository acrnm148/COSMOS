...
const [user, setUser] = useRecoilState(userState)
    return (
        <div className="flex flex-col justify-center items-center max-w-[950px] m-auto">
            <div ref={targetRef} className="scroll position-fixed left-[50%] z-index-50 px-[10px] top-1.5 py-0 align-center transform:-translate-y-[50%] transition-all transition-duration:150ms">
              <Header />
            </div>
