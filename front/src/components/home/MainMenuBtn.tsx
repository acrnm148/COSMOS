...
export default function MainMenuBtn() {
  ...
  return (
    <div className="flex flex-row btns w-full h-44 pt-3 justify-center">
      <div className="basis-1/2 mr-3 h-full relative float-left p-4 bg-lightMain4 rounded-2xl drop-shadow-lg dark:bg-darkMain3">
        ...
        <NavLink
          to="/place/recommend"
          className="absolute bottom-3 block m-auto"
        >
          {isDark ? (
            <img src={SoloBike} alt="recomm-btn" className="h-24 w-36" />
          ) : (
      ...
      <div className="basis-1/2 ml-1 h-full float-left relative p-4 bg-lightMain4 rounded-2xl drop-shadow-lg dark:bg-darkMain3">
        <div className="title font-bold dark:text-white">
          장소 검색
          <Icon
            icon="ic:outline-keyboard-arrow-right"
        ...
        <NavLink
          to="/place/search"
          className="absolute bottom-3 right-5 block m-auto"
        >
          {isDark ? (
            <img src={DarkMainSearch} alt="recomm-btn" className="h-20 w-28" />
          ) : (
