...
export default function WishPlace() {
  ...
  return (
    <div className="h-full mb-28 bg-darkBackground">
      <div className="mx-5 mt-5">
        ...
        <div className="mt-4 h-[480px] overflow-y-auto">
          {list?.map((p: Place) => (
            <Item key={p.placeId} item={p} userSeq={userSeq[0].seq}></Item>
          ))}
        </div>
  ...
  return (
    ...
    >
      ...
      <div className="star ml-2 mb-1">
        <Star fontSize="small" sx={{ color: isDark ? "#BE6DB7" : "#FF8E9E" }} />
        <p
          className={
            isDark
      ...
      <div
        className={
          isDark ? "mb-2 text-sm text-slate-300" : "mb-2 text-sm text-gray-500"
        }
      >
        {address}
      </div>
