  ...
  return (
    <div className="relative">
      ...
      <div
        className={
          isDark
            ? "cursor-pointer btns w-full h-12 bg-darkMain3 text-center flex absolute bottom-0 z-[100001]"
            : "cursor-pointer btns w-full h-12 bg-lightMain3 text-center flex absolute bottom-0 z-[100001]"
        }
      >
