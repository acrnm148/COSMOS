  ...
  return (
    <div className="h-[59vh] overflow-auto">
      ...
      <div
        className={
          isDark
            ? "cursor-pointer w-full absolute bottom-20 h-16 pt-4 text-center bg-darkMain z-[100001] text-white text-xl font-bold"
            : "cursor-pointer w-full absolute bottom-20 h-16 pt-4 text-center bg-lightMain2 z-[100001] text-white text-xl font-bold"
        }
        onClick={() => {
          (async () => {
