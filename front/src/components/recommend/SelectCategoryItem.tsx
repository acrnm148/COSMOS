...
export default function SelectCategoryItem({ number, tags }: any) {
  const num = number;
  const [tag, setTag] = useState(tags);

  return (
    <div className="modal-content first-child">
      <span className="category-number">{num}</span>
      <div
        className={tag[0] ? "content-clicked" : ""}
      ...
      <div
        className={tag[1] ? "content-clicked" : ""}
      ...
      <div
        className={tag[2] ? "content-clicked" : ""}
      ...
      <div
        className={tag[3] ? "content-clicked" : ""}
      ...
      <div
        className={tag[4] ? "content-clicked" : ""}
      ...
      <div
        className={tag[5] ? "content-clicked" : ""}
