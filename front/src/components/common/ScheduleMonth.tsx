...
export function ScheduleMonth(props:{year:string, month:string}){
    ...
    return(
        <div className={(isDark?
            ...
            :"bg-lightMain2 h-20 flex items-center justify-between p-5 text-xl font-bold text-white cursor-pointer") + "items-center justify-between p-5 text-xl font-bold text-white cursor-pointer"}>           <NavLink to={"/schedule/month"}><p >{props.year}년 {props.month}월</p> </NavLink>
