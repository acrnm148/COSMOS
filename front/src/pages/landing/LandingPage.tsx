...
export default function LandingPage() {
  ...
  const firstComponentHeight =
    React.useRef() as React.MutableRefObject<HTMLDivElement>; // 랜딩 사진 높이
    ...
    const wheelHandler = () => {
      ...
      if (deltaY > 0) {
        ...
        if (currentY >= 0 && currentY < firstHeight) {
          ...
          currentY < pageHeight + firstHeight
        ) {
          // 2페이지
  ...
  return (
    <div
      className="scroll-box scrollbar-hide ScrollSnapWrap outer"
      ref={outerDivRef}
    >
      <div className="bg-local w-full SnapDiv inner" ref={firstComponentHeight}>
        <img src={LightLanding} alt="landing" className="w-screen" />
