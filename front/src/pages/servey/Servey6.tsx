    ...
    return(
        <div className="">
            ...
            <div className="mt-7 mb-7 w-full text-center">
                ...
                <div className="border-solid border-2 h-5 border-darkMain w-full"><div className="h-full bg-darkMain w-7/12"></div></div>
            </div>
            <h1 className="font-baloo text-base text-white mb-2">6. 야경을 보러간다면?</h1>
            <div className="flex flex-wrap w-full grid-rows-2 gap-2 justify-center">
            {[['호텔 라운지에서 보는', '도시 야경'],['공원에서 자전거타며', '강변야경'], ['캠핑장에서 올려다보는', '밤하늘'], ['집에서 유튜브로 보는', 'VR 야경']].map((item, key) => {
                return (
                <div
                    key={key}
                    onClick={()=>submit6(key)}
                    className={'flex w-40 justify-center p-5 content-center text-center bg-darkMain4 pt-10 pb-10 rounded-lg break-normal hover:bg-opacity-75  border-solid border-2 border-darkMain4'}
                >
                    <div className="">
