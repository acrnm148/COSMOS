    ...
    return(
        <div className="">
            ...
            <div className="mt-7 mb-7 w-full text-center">
                ...
                <div className="border-solid border-2 h-5 border-darkMain w-full"><div className="h-full bg-darkMain w-3/12"></div></div>
            </div>
            <h1 className="font-baloo text-base text-white mb-2">3. 더 가고싶은 데이트장소?</h1>
            <ul className="flex flex-wrap w-full grid-rows-2 gap-2 justify-center">
            {['공원피크닉', '미술전시회', '불꽃축제','밤새영화보기'].map((item, key) => {
                return (
                <div
                    key={key}
                    onClick={()=>submit3(key)}
                    className={'flex justify-center w-40 h-40 p-5 content-center text-center bg-darkMain4 pt-10 pb-10 rounded-lg break-normal hover:bg-opacity-75  border-solid border-2 border-darkMain4'}
                >
