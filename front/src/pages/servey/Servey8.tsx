    ...
    return(
        <div className="">
            ...
            <div className="mt-7 mb-7 w-full text-center">
                ...
                <div className="border-solid border-2 h-5 border-darkMain w-full"><div className="h-full bg-darkMain w-10/12"></div></div>
            </div>
            <h1 className="font-baloo text-base text-white mb-2">8. 주로 찾는 데이트장소의 분위기?</h1>
            <ul className="flex flex-wrap w-full grid-rows-2 gap-2 justify-center">
            {['사람들로 북적이는 활기있는 장소', '둘이서 얘기하기 좋은 조용한 장소'].map((item, key) => {
                return (
                <div
                    key={key}
                    onClick={()=>submit8(key)}
