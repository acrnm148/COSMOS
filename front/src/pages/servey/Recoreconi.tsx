...
import { charCountState, testState } from "../../recoil/states/ServeyPageState";
...
export default function Recoreconi() {
  ...
  return (
    <>
      ...
      <span className="text-darkMain">
        여기에 입력하면 취향설문 제목이 바뀝니다 {">"}
      </span>
      <input
        className="border-solid border-2 border-darkMain"
        type="text"
        value={test.value}
