    ...
    return(
        <div className="w-full">
            ...
            <div className="mt-7 mb-7 w-full text-center">
                ...
                <div className="border-solid border-2 h-5 border-darkMain w-full"><div className="h-full bg-darkMain w-4/12"></div></div>
            </div>
            <h1 className="font-baloo text-base text-white mb-2">4. 선호하는 데이트장소?</h1>
