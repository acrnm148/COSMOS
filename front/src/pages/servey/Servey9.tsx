    ...
    return(
        <div className="">
            ...
            <div className="mt-7 mb-7 w-full text-center">
                ...
                <div className="border-solid border-2 h-5 border-darkMain w-full"><div className="h-full bg-darkMain w-full"></div></div>
            </div>
            <h1 className="font-baloo text-base text-white mb-2">9. 당신의 취미는 어디에 더 가깝나요?</h1>
